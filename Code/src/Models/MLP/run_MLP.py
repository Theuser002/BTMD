...
if __name__ == "__main__":
    ...
    for fold in trained_folds:
        ...
        if save == 'save':
            ...
            best_accs = train_MLP.run(fold, train_loader, val_loader, model, criterion, optimizer, cfg)
        else:
            print('Running in no save mode')
            best_accs = train_MLP.run_no_save(fold, train_loader, val_loader, model, criterion, optimizer, cfg)
